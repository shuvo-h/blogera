        ...
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
            <div className="mx-6 py-10 text-center md:text-left">
                ...
                <div className="">
                    ...
                    <p className="mb-4">
                    <a href="#!" className="text-gray-600">Awards</a>
                    </p>
                    <p className="mb-4">
                    <a href="#!" className="text-gray-600">Working Hours</a>
                    </p>
                    <p>
                    <a href="#!" className="text-gray-600">Procedures</a>
                    </p>
                    <p>
                    <a href="#!" className="text-gray-600">Special Offers</a>
                    </p>
                    <p>
                    <a href="#!" className="text-gray-600">FAQ’s</a>
                    </p>
                </div>
                <div className="">
                    <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                    ...
                    <p className="mb-4">
                    <a href="#!" className="text-gray-600">Healthy Foods</a>
                    </p>
                    <p className="mb-4">
                    <a href="#!" className="text-gray-600">Appointments</a>
                    </p>
                    <p>
                    <a href="#!" className="text-gray-600">Latest News</a>
                    </p>
                </div>
                <div className="">
                    <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
            ...
            <div className="text-center p-6 bg-gray-200">
                ...
                <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Health Guard Hospital</a>
            </div>
        </footer>
    );
};
